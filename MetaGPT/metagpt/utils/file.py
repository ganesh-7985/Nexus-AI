...
async def is_text_file(filename) -> Tuple[bool, str]:
    """Lightweight stub replacing repo_to_markdown.is_text_file."""
    import mimetypes
    mime, _ = mimetypes.guess_type(str(filename))
    if mime and mime.startswith("text"):
        return True, mime
    return False, mime or ""
